...
function DesktopHeader() {
  return (
    <header className="bg-white">
      <div className="mx-auto grid h-[99px] w-full max-w-[1900px] grid-cols-[auto_1fr_auto] items-center px-[40px] xl:px-[72px] 2xl:px-[96px]">
        <a
          href="#top"
        ...
        <nav className="flex items-center justify-center gap-10 xl:justify-start xl:pl-24 2xl:gap-16">
          {navItems.map((item) => (
            <a
              key={item}
              href="#"

    ...
    <section className="bg-white lg:hidden">
      <div className="mx-auto w-full max-w-[375px] px-[20px] py-[10px]">
        <div className="flex flex-col gap-[12px]">
          ...
          <button
            type="button"
            className="h-[42px] w-full rounded-[8px] bg-[#FE001A] text-[16px] font-bold text-white shadow-[0_10px_24px_rgba(254,0,26,0.18)]"
          >
            Get Started
          </button>

          <div className="pt-[8px]">
            <p className="text-[20px] font-medium uppercase tracking-[0.04em] text-[#FE001A]">
              VIDEO LIBRARY
            </p>
            ...
            <div className="relative mt-[20px] aspect-[335/330] w-full overflow-hidden rounded-[18px] bg-[#111] shadow-[0_18px_42px_rgba(0,0,0,0.10)]">
              <Image
...
function DesktopVideoLibrarySection() {
  return (
    <section className="mx-auto hidden w-full max-w-[1450px] px-[80px] py-[36px] lg:block lg:py-[46px]">
      <div className="grid items-center gap-[40px] lg:grid-cols-[0.92fr_1.08fr] lg:gap-[48px]">
        <div className="flex flex-col justify-start">
          ...
          <div className="mt-[30px] flex max-w-[518px] flex-col gap-3 sm:flex-row sm:items-center">
            ...
            >
              <span className="font-bold tracking-[0.05em]">Get Started</span>
            </button>
          </div>
        </div>
